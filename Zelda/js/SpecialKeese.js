...
zelda.SpecialKeese = function(game,x,y,type,level,initSpeed){
    this.hurt = false;
    ...
    zelda.SpecialKeese.NotHurt = function(obj){
        obj.hurt = false;   
        obj.body.velocity = obj.previousVelocity;
    }

zelda.SpecialKeese.prototype = Object.create(Phaser.Sprite.prototype);

zelda.SpecialKeese.prototype.constructor = zelda.SpecialKeese;

zelda.SpecialKeese.Respawn = function (obj){
...
zelda.SpecialKeese.prototype.update = function(){
    if(this.spawned){
        if(this.Alive){
            if(this.lives==0){
            ...
            if(!zelda.Inventory.ScrollingInventory&&!zelda.Inventory.InvON){
                ...
                this.animations.play("Move");
                    ...
                    this.game.time.events.add(Phaser.Timer.SECOND * 1.2,zelda.SpecialKeese.MoveFaster, this.level,this);
                ...
                if(!this.hurt){
                    ...
                    if(!this.calledNotHurt){
                        this.calledNotHurt = true;
                        this.game.time.events.add(Phaser.Timer.SECOND * 0.2,zelda.SpecialKeese.NotHurt, this.level,this);
                    }
                }
            }else{
                if(!this.wasPaused){
...
zelda.SpecialKeese.MoveFaster = function(obj){
